...
public class Game_board extends Fragment {
    ...
    private List<com.example.DogRoyalClient.GameInformationClasses.Color> start_colors; //Colors of the startfields (still in Color class not only required color value)
