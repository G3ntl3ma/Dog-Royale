...
public class RunningGamesTest {
    ...
    public void testNavigation_Spectategames_menü() {
        ...
        FragmentScenario<SpectateGames> startFragmentScenario = FragmentScenario.launchInContainer(RunningGames.class);
        //zu sicher aller View
        Espresso.onView(ViewMatchers.withId(R.id.action_SpectateGames_to_waitingScreen)).check(ViewAssertions.matches(isDisplayed()));
        //runing Click
        Espresso.onView(ViewMatchers.withId(R.id.action_SpectateGames_to_waitingScreen)).perform(ViewActions.click());
